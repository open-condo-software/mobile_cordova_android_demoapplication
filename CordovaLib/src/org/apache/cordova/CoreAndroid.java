...
public class CoreAndroid extends CordovaPlugin {
            ...
            if (action.equals("clearCache")) {
                ...
                synchronized(messageChannelLock) {
                    ...
                    if (pendingResume != null) {
                        Log.d("CORDOVA","sendEventMessage pendingResume");
    ...
    private void sendEventMessage(PluginResult payload) {
        ...
        if (messageChannel != null) {
            Log.d("CORDOVA","sendEventMessage messageChannel = " + messageChannel);
    ...
    public void sendResumeEvent(PluginResult resumeEvent) {
        ...
        synchronized(messageChannelLock) {
            if (messageChannel != null) {
                ...
                Log.d("CORDOVA","sendResumeEvent messageChannel != null");
            } else {
                ...
                Log.d("CORDOVA","sendResumeEvent pendingResume");
